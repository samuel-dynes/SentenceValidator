...
class Test_EvenQuoteCountValidator
{
   ...
   void shouldCorrectlyEvaluateQuotesInStrings(String inputString, Boolean expectedResult)
   {
   ...
   {
      return Stream.of(
         Arguments.of("\"Example valid quote count\"", true),
         Arguments.of("\"Example invalid\" quote count\"", false),
         Arguments.of("Example valid quote count", true),
         Arguments.of("", true),
